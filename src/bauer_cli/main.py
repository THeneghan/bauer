...
import typer
from bauer_utils.db import create_postgres_container, destroy_postgres_container
...
@app.command()
def create_generic_local_db(container_name: Annotated[Optional[str], typer.Argument()] = "bauer_local_db"):
